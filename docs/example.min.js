    ...
    var Footer = {
        view: function (_a) {
            ...
            return (mithril("footer", { class: "footer " + (env && env === 'staging' ? 'staging' : '') },
                mithril("div", { class: "footer__media-links" },
                    mithril("div", { class: "mb1" },
                        mithril("strong", null, headline || 'Sie finden uns auch auf')),
                    mithril("div", { class: "footer__media-icons" },
                        mithril("a", { href: urls.PHXWEBSITE, title: "Phoenix Reisen", target: "_blank", rel: "noopener noreferrer", class: "desktop-only" },
                            mithril("img", { src: ICON_PHX, alt: "Phoenix Reisen Website" })),
                        mithril("a", { href: urls.FACEBOOK, title: "Phoenix Reisen TV auf Facebook", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_FB, alt: "Phoenix Reisen TV auf Facebook" })),
                        mithril("a", { href: urls.YOUTUBE, title: "Phoenix Reisen TV auf YouTube", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_YT, alt: "Phoenix Reisen TV auf YouTube" })),
                        mithril("a", { href: urls.PHXTV, title: "Phoenix TV", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_TV, alt: "Phoenix TV" })),
                        mithril("a", { href: urls.INSTAGRAM, title: "Phoenix Reisen auf Instagram", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_INSTA, alt: "Phoenix Reisen auf Instagram" })),
                        mithril("a", { href: urls.INSTAGRAM_HASHTAG, title: "Impressionen unserer G\u00E4ste", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_HASH, alt: "Impressionen unserer G\u00E4ste - #phoenixreisen" })),
                        mithril("a", { href: urls.TWITTER, title: "Phoenix Reisen auf Twitter", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_TWITTER, alt: "Phoenix Reisen auf Twitter" })))),
                mithril("div", { class: "mt2 tc footer__text" },
                    mithril("div", null,
                ...
                mithril("div", { class: "wrapper wrapper--large footer__links-wrapper" },
                    mithril("ul", { class: "footer__links noprint" },
                        mithril("li", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/profibereich.html", title: "zum Reiseb\u00FCro-/Profibereich" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Reiseb\u00FCro-/Profibereich")),
                        mithril("li", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/reise-und-geschaeftsbedingungen.html", title: "zu unseren AGB" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "AGB")),
                        mithril("li", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/datenschutzerklaerung.html", title: "zu unserer Datenschutzerkl\u00E4rung" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Datenschutzerkl\u00E4rung")),
                        mithril("li", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/kontakt.html", title: "zu unserer Kontaktseite" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Kontakt")),
                        mithril("li", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/nutzungsbedingungen.html", title: "zu unseren Nutzungsbedingungen" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Nutzungsbedingungen")),
                        mithril("li", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/impressum.html", title: "zu unserem Impressum" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Impressum"))),
