(function () {
    ...
    var ICON_TV = "6984dc63540dc595.png";

    var ICON_YT = "8b1e07eb358ae2e6.png";

    var ICON_FB = "aba35373cc033c7b.png";

    var ICON_QG = "234831d1fe038ac5.png";

    var ICON_DRV = "e6b16c2b7b899e2c.png";

    var ICON_INSTA = "aa9975e27df4db5a.png";

    var ICON_TWITTER = "e7eaf016fad1ffde.png";

    var ICON_PHX = "9da70b3340e61141.jpg";

    var ICON_HASH = "8f489b3507321698.png";

    var Footer = {
        view: function (_a) {
            var attrs = _a.attrs;
            var interns = Config.urls;
            var headline = attrs.headline, env = attrs.env, externs = attrs.urls;
            var urls = Object.assign({}, interns, externs);
            return (mithril("footer", { class: "footer " + (env && env === 'staging' ? 'staging' : '') },
                mithril("div", { class: "social-media" },
                    mithril("div", { class: "mb1" },
                        mithril("strong", null, headline || 'Sie finden uns auch auf')),
                    mithril("div", { class: "social-media__icons" },
                        mithril("a", { href: urls.PHXWEBSITE, class: "social-media__icon desktop-only", title: "Phoenix Reisen", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_PHX, alt: "Phoenix Reisen Website" })),
                        mithril("a", { href: urls.FACEBOOK, class: "social-media__icon", title: "Phoenix Reisen TV auf Facebook", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_FB, alt: "Phoenix Reisen TV auf Facebook" })),
                        mithril("a", { href: urls.YOUTUBE, class: "social-media__icon", title: "Phoenix Reisen TV auf YouTube", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_YT, alt: "Phoenix Reisen TV auf YouTube" })),
                        mithril("a", { href: urls.PHXTV, class: "social-media__icon", title: "Phoenix TV", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_TV, alt: "Phoenix TV" })),
                        mithril("a", { href: urls.INSTAGRAM, class: "social-media__icon", title: "Phoenix Reisen auf Instagram", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_INSTA, alt: "Phoenix Reisen auf Instagram" })),
                        mithril("a", { href: urls.INSTAGRAM_HASHTAG, class: "social-media__icon", title: "Impressionen unserer G\u00E4ste", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_HASH, alt: "Impressionen unserer G\u00E4ste - #phoenixreisen" })),
                        mithril("a", { href: urls.TWITTER, class: "social-media__icon", title: "Phoenix Reisen auf Twitter", target: "_blank", rel: "noopener noreferrer" },
                            mithril("img", { src: ICON_TWITTER, alt: "Phoenix Reisen auf Twitter" })))),
                mithril("div", { class: "social-contact mt2 tc" },
                    mithril("div", null,
                        mithril("small", null, "Wir sind f\u00FCr Sie da")),
                    mithril("div", null,
                        mithril("strong", null,
                            mithril("a", { href: "tel:+4922892600", title: "Telefonnummer aufrufen" }, "+49 (228) 9260-0")),
                        " oder \u00FCber ",
                        mithril("strong", null,
                            mithril("a", { href: "https://www.phoenixreisen.com/kontakt.html", title: "Kontaktformular", target: "_blank", rel: "noopener noreferrer" }, "Kontaktformular")),
                        mithril("br", null),
                        mithril("small", null, "montags bis freitags von 09:00 bis 18:00 Uhr"))),
                mithril("div", { class: "wrapper wrapper--large footer__wrapper" },
                    mithril("ul", { class: "footer__menu noprint" },
                        mithril("li", { class: "footer__menu-item" },
                            mithril("a", { href: "https://www.phoenixreisen.com/profibereich.html", title: "zum Reiseb\u00FCro-/Profibereich", class: "footer__menu-link" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Reiseb\u00FCro-/Profibereich")),
                        mithril("li", { class: "footer__menu-item" },
                            mithril("a", { href: "https://www.phoenixreisen.com/reise-und-geschaeftsbedingungen.html", title: "zu unseren AGB", class: "footer__menu-link" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "AGB")),
                        mithril("li", { class: "footer__menu-item" },
                            mithril("a", { href: "https://www.phoenixreisen.com/datenschutzerklaerung.html", title: "zu unserer Datenschutzerkl\u00E4rung", class: "footer__menu-link" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Datenschutzerkl\u00E4rung")),
                        mithril("li", { class: "footer__menu-item" },
                            mithril("a", { href: "https://www.phoenixreisen.com/kontakt.html", title: "zu unserer Kontaktseite", class: "footer__menu-link" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Kontakt")),
                        mithril("li", { class: "footer__menu-item" },
                            mithril("a", { href: "https://www.phoenixreisen.com/nutzungsbedingungen.html", title: "zu unseren Nutzungsbedingungen", class: "footer__menu-link" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Nutzungsbedingungen")),
                        mithril("li", { class: "footer__menu-item" },
                            mithril("a", { href: "https://www.phoenixreisen.com/impressum.html", title: "zu unserem Impressum", class: "footer__menu-link" },
                                mithril("i", { class: "fa fa-angle-right" }),
                                "Impressum"))),
                    mithril("div", { class: "footer__logos" },
                        mithril("span", { class: "footer__logo" },
                            mithril("img", { src: ICON_DRV })),
                        mithril("span", { class: "footer__logo" },
                            mithril("img", { src: ICON_QG }))))));
        },
    };
    ...
    var Demo = {
        view: function () {
            return (mithril("div", { class: "footer-demo" },
                mithril(Footer$1, null)));
        }
    };
